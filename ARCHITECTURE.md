...
│  │                    CheckoutService                                │     │
│  │  ┌──────────────────────────────────────────────────────┐        │     │
│  │  │ processCheckout() - UPDATED                           │        │     │
│  │  │  1. Validate products (availability check)           │        │     │
│  │  │  2. Validate delivery location                       │        │     │
│  │  │  3. Calculate total price                            │        │     │
│  │  │  4. Create order with PENDING status ⭐              │        │     │
│  │  │  5. Do NOT auto-assign delivery guy                  │        │     │
│  │  │  6. Delivery guys will claim from available pool     │        │     │
│  │  │  Note: Orders wait for delivery guy to accept       │        │     │
│  │  └──────────────────────────────────────────────────────┘        │     │
│  │  ┌──────────────────────────────────────────────────────┐        │     │
│  │  │ calculatePrice()                                      │        │     │
...
│  │  │  3. Create DeliveryGuy entity                         │        │     │
│  │  │  4. Add ROLE_DELIVERY to user                         │        │     │
│  │  │  5. Return profile                                    │        │     │
│  │  └──────────────────────────────────────────────────────┘        │     │
│  │  ┌──────────────────────────────────────────────────────┐        │     │
│  │  │ getProfile()                                          │        │     │
│  │  │  - Returns delivery guy profile or unregistered      │        │     │
│  │  └──────────────────────────────────────────────────────┘        │     │
│  │  ┌──────────────────────────────────────────────────────┐        │     │
│  │  │ getAvailableOrders()                                  │        │     │
│  │  │  1. Find all orders with PENDING status              │        │     │
│  │  │  2. Calculate distance for each order                │        │     │
│  │  │  3. Return detailed order list                       │        │     │
│  │  └──────────────────────────────────────────────────────┘        │     │
│  │  ┌──────────────────────────────────────────────────────┐        │     │
│  │  │ acceptOrder()                                         │        │     │
│  │  │  1. Validate delivery guy registered                 │        │     │
│  │  │  2. Validate order is PENDING                        │        │     │
│  │  │  3. Update order to ASSIGNED                         │        │     │
│  │  │  4. Link delivery guy to order                       │        │     │
│  │  │  5. Calculate distance                               │        │     │
│  │  │  6. Mark delivery guy unavailable                    │        │     │
